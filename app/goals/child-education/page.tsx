    ...
    <div className="relative min-h-screen bg-white text-[#2C5282] pt-18">
      ...
      <div className="max-w-2xl mx-auto px-4 py-16">
        <div className="flex items-center gap-3 mb-6">
          <Image src="/goals/child-education.png" alt="Child&apos;s Education" width={64} height={64} className="w-16 h-16 object-cover rounded" />
          <h1 className="text-3xl font-bold">Child&apos;s Education Goal Calculator</h1>
        </div>
        <p className="text-gray-600 mb-8">
          Estimate the future cost of your child&apos;s education by factoring in inflation and your time horizon.
        </p>
        <div className="bg-white rounded-lg shadow p-6">
          <div className="mb-4">
            <label className="block mb-1 font-medium">Current Education Cost (₹):</label>
            <input type="number" value={currentCost} onChange={e => setCurrentCost(Number(e.target.value))} className="border rounded p-2 w-full" />
          </div>
          <div className="mb-4">
            <label className="block mb-1 font-medium">Years Until Education:</label>
          ...
          {futureCost !== null && (
            <div className="mt-6 text-lg font-semibold text-center bg-blue-50 p-4 rounded">
              Future Education Cost: ₹{futureCost.toLocaleString()}
            </div>
          )}
        </div>
      </div>
